...
public class Gmail
{
    ...
    public void test() {
        ...
        driver.findElement(By.name("YPqjbf")).sendKeys("welcome");
        highlight(driver,driver.findElement(By.name("YPqjbf")));
        driver.findElement(By.className("whsOnd zHQkBf"));
        highlight(driver,driver.findElement(By.className("whsOnd zHQkBf")));
